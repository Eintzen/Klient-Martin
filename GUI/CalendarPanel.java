...
public class CalendarPanel extends JPanel {
	...
	private static JLabel lblFirstDate, lblSecondDate, lblThirdDate, lblFourthDate, lblFifthDate, lblSixthDate, lblSeventhDate, lblPleaseWait;
      ...
      //Set bounds
		...
		try {
			...
			changeCalendar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					CalendarLogic ic = new CalendarLogic();
					String selectedCal = (String) changeCalendar.getSelectedItem();
					try {
			...
			lblTemperature.setBounds(15, 416, 120, 16);
			add(lblTemperature);
			
			lblTemperatureSummary = new JLabel("Description: ");
			lblTemperatureSummary.setBounds(15, 437, 162, 16);
...
=======
					//lcd.LoadCalendarFromServer("CBS Calendar");
>>>>>>> Stashed changes
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
		...
		for(int i = 0; i < lcd.getMatchedEvents().size(); i++){
			...
			event.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					// Don't "delete event"-button for CBS Calendar
					if(selectedCalendar.equals("CBS Calendar")){
						getBtnDeleteEvent().setVisible(false);
					} else {
